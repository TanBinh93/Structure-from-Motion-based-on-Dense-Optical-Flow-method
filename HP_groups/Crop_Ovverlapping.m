...
% Output:    + I1_crop, I2_crop: the two sub-images on the overlapping region of Id1, Id2.
%            + L is a matrix contains the central point of each image.
%            + vector_movv: the vector movement between image Id1 and image  Id2

function [I1_crop,I2_crop,L,vector_movv] = Crop_Ovverlapping(image_path,U1,V1,Id1,Id2,Num,format_images)
