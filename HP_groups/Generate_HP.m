...
%
%  In this function, we use: + tvFlow_calc.m for computing the optical flow between two images.
%                            + forward_consecutive_OF.m for the forward optical flow computation of sequence images.                       
